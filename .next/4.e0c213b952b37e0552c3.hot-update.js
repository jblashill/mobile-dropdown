  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      var baseClass = this.props.optionalBaseClassName,
          ...
          optionsClass = __WEBPACK_IMPORTED_MODULE_3_classnames___default()((_classNames4 = {}, _defineProperty(_classNames4, "".concat(baseClass, "__options-wrapper"), true), _defineProperty(_classNames4, "".concat(baseClass, "__options-wrapper--visible"), this.state.isOpen), _classNames4)),
          options = __WEBPACK_IMPORTED_MODULE_0_react___default.a.Children.map(children, function (child) {
...
function (_Component) {
  ...
  _createClass(Option, [{
    ...
    value: function render() {
      var baseClass = this.props.optionalBaseClassName,
          optionClass = __WEBPACK_IMPORTED_MODULE_3_classnames___default()(_defineProperty({}, "".concat(baseClass, "__option"), true));
...
//# sourceMappingURL=4.e0c213b952b37e0552c3.hot-update.js.map