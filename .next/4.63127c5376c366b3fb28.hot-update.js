  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      var baseClass = this.props.optionalBaseClassName,
          ...
          overlayClass = __WEBPACK_IMPORTED_MODULE_3_classnames___default()((_classNames3 = {}, _defineProperty(_classNames3, "".concat(baseClass, "__overlay"), true), _defineProperty(_classNames3, "".concat(baseClass, "__overlay--visible"), this.state.isOpen.isOpen), _classNames3)),
      ...
      var options; // if (this.state.isOpen) {
      //     options = [
      //         <div className={overlayClass} />,
      //         <div className={optionsClass}>{this.props.children}</div>
      //     ];
      // }
...
//# sourceMappingURL=4.63127c5376c366b3fb28.hot-update.js.map