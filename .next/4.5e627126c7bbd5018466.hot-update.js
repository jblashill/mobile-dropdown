  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      var baseClass = this.props.optionalBaseClassName,
          ...
          overlayClass = __WEBPACK_IMPORTED_MODULE_3_classnames___default()((_classNames3 = {}, _defineProperty(_classNames3, "".concat(baseClass, "__overlay"), true), _defineProperty(_classNames3, "".concat(baseClass, "__overlay--visible"), this.state.isOpen), _classNames3)),
          optionsWrapperClass = __WEBPACK_IMPORTED_MODULE_3_classnames___default()((_classNames4 = {}, _defineProperty(_classNames4, "".concat(baseClass, "__option-wrapper1"), true), _defineProperty(_classNames4, "".concat(baseClass, "__option-wrapper--visible"), this.state.isOpen), _classNames4)),
          optionsClass = __WEBPACK_IMPORTED_MODULE_3_classnames___default()((_classNames5 = {}, _defineProperty(_classNames5, "".concat(baseClass, "__option-wrapper"), true), _defineProperty(_classNames5, "".concat(baseClass, "__option-wrapper--visible"), this.state.isOpen), _classNames5)),
...
//# sourceMappingURL=4.5e627126c7bbd5018466.hot-update.js.map